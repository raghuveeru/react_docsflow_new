var API = {
	...
	BUDGET: {
		...
		GET_ROUTING_HISTORY: 'api/routing-history.json'
	},
	TOPICS: {
	...
	USERS: {
		...
		GET_ALL_PERMISSIONS: 'api/docsflow-permissions',
		CREATE_NEW_PERMISSION: 'api/create-new-permission.json',
		UPDATE_PERMISSION: 'api/create-new-permission.json',
		DELETE_PERMISSION: 'api/delete_permission.json',

		GET_ALL_ROLES: 'api/docsflow-roles.json',
		CREATE_NEW_ROLE: 'api/create-new-role.json',
		UPDATE_ROLE: 'api/create-new-role.json',
		DELETE_ROLE: 'api/delete-role.json',
		GET_ALL_DEPARTMENTS: 'api/user-department.json'
	},
	NOTIFICATIONS: {
